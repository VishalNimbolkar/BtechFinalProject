...
<div class="ch-container">
		            ...
		            <div class="row">
		               <div>
						   ...
						   <div>
						      ...
						      <div class="col-xs-1">
						      <br><br><br>
						          <a href="user_home.jsp"><button type="button" class="btn btn-primary" style="width:160px">HOME</button><br></a>
						          <br>
							      <a href="tokenazationFB.jsp"><button type="button" class="btn btn-primary" style="width:160px">Tokenization</button></a><br>
							      <br>
							      <a href=""><button type="button" class="btn btn-primary" style="width:160px">Stop Word Removal</button></a><br>
							      <br>
							      <a href=""><button type="button" class="btn btn-primary" style="width:160px">Stemming</button></a><br>
							      <br>
							     
							      <a href=""><button type="button" class="btn btn-primary" style="width:160px">Classification</button></a><br>
							      <br>
							      <a href=""><button type="button" class="btn btn-primary" style="width:160px">Prediction</button></a><br>
							      <br>
							      <br>
							  </div>			
						   </div>
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="#" target="_blank"></a> 2022 - 2023</p>

        <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Powered by: <a href="#">Meta</a></p>
    </footer>
