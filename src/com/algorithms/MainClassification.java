...
public class MainClassification<T, K> extends FBClassifier<T, K> {
     ...
     */
    private SortedSet<FBClassification<T, K>> categoryProbabilities(
            Collection<T> features) {

       
        SortedSet<FBClassification<T, K>> probabilities =
                new TreeSet<FBClassification<T, K>>(
                        new Comparator<FBClassification<T, K>>() {

                    @Override
                    public int compare(FBClassification<T, K> o1,
                    		FBClassification<T, K> o2) {
        ...
        for (K category : this.getCategories())
            probabilities.add(new FBClassification<T, K>(
                    features, category,
     ...
     */
    @Override
    public FBClassification<T, K> classify(Collection<T> features) {
        SortedSet<FBClassification<T, K>> probabilites =
     ...
     */
    public Collection<FBClassification<T, K>> classifyDetailed(
            Collection<T> features) {
